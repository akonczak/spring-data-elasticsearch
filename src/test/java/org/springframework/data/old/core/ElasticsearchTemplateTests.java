 ...
 */
package org.springframework.data.old.core;
...
/*	*//*
	...
	public void shouldCreateIndexGivenEntityClass() {
		...
		assertThat(setting.get("index.numberOfShards"), Matchers.<Object>is("1"));
		assertThat(setting.get("index.numberOfReplicas"), Matchers.<Object>is("0"));
	}
	...
	*//*
	...
	public void shouldCreateGivenSettingsForGivenIndex() {
		...
		assertThat(map.containsKey("index.numberOfReplicas"), is(true));
		assertThat(map.containsKey("index.numberOfShards"), is(true));
		assertThat(map.containsKey("index.store.type"), is(true));
		assertThat((String) map.get("index.refresh_interval"), is("-1"));
		assertThat((String) map.get("index.numberOfReplicas"), is("0"));
		assertThat((String) map.get("index.numberOfShards"), is("1"));
	...
	*//**
	...
	public void shouldCreateIndexUsingServerDefaultConfiguration() {
		...
		assertThat(setting.get("index.numberOfShards"), Matchers.<Object>is("5"));
		assertThat(setting.get("index.numberOfReplicas"), Matchers.<Object>is("1"));
	}
